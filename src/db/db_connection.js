    ...
    new Promise((resolve, reject) => {
        db.transaction(tx => {
            ...
            tx.executeSql("CREATE TABLE IF NOT EXISTS "
                + "TRIP"
                + "(ID INTEGER PRIMARY KEY AUTOINCREMENT, destination TEXT,destinationImage TEXT, placeId TEXT,name TEXT,startDate TEXT,endDate TEXT);", [], (tx, results) => {
                    const { rows } = results;
                    let users = [];
            ...
            tx.executeSql(
                ...
                + "PLAN"
                + "(ID INTEGER PRIMARY KEY AUTOINCREMENT,ALERT INTEGER DEFAULT 0,TIMEZONE TEXT, event TEXT,venue TEXT,startDate TEXT,endDate TEXT, TripID int, FOREIGN KEY (TripID) REFERENCES TRIP(ID));")
